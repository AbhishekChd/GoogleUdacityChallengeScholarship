...
//        COMPLETED (7) Display the weather icon using mDetailBinding
        ...
        mDetailBinding.primaryInfo.weatherIcon.setImageResource(iconResource);
...
//      COMPLETED (16) Set the content description of the icon to the same as the weather description a11y text
        String weatherDescA11y = getString(R.string.a11y_forecast_icon, description);
        mDetailBinding.primaryInfo.weatherIcon.setContentDescription(weatherDescA11y);
